<?php
    ...
    $result = pg_prepare($conn, "my_query", 'INSERT INTO zamestnanci (jmeno, prijmeni, prihlasovaci_jmeno, heslo, fk_pozice, fk_specializace) VALUES ($1, $2, $3, $4, $5, $6)');
    $result = pg_execute($conn, "my_query", array($jmeno, $prijmeni, $prih_jmeno, $heslo, $pozice_id, $specializace_id));
